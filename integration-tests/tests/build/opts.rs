...
use cargo_unc_integration_tests::build_fn_with;
use function_name::named;
use std::fs;

#[test]
#[named]
fn test_build_no_abi() -> cargo_unc::CliResult {
...
#[tokio::test]
#[named]
async fn test_build_no_embed_abi() -> cargo_unc::CliResult {
    let build_result = build_fn_with! {
        Opts: "--no-embed-abi";
        Code:
        pub fn add(&self, a: u32, b: u32) -> u32 {
...
#[test]
#[named]
fn test_build_no_doc() -> cargo_unc::CliResult {
    let build_result = build_fn_with! {
        Opts: "--no-doc";
        Code:
        /// Adds `a` and `b`.
...
#[test]
#[named]
fn test_build_opt_out_dir() -> cargo_unc::CliResult {
...
#[tokio::test]
#[named]
async fn test_build_no_release() -> cargo_unc::CliResult {
    let build_result = build_fn_with! {
        Opts: "--no-release";
        Code:
        pub fn add(&self, a: u32, b: u32) -> u32 {
