use cargo_unc_integration_tests::generate_abi_fn_with;
use function_name::named;
use std::fs;

#[test]
#[named]
fn test_abi_no_doc() -> cargo_unc::CliResult {
...
#[test]
#[named]
fn test_abi_opt_compact_abi() -> cargo_unc::CliResult {
...
#[test]
#[named]
fn test_abi_opt_out_dir() -> cargo_unc::CliResult {
