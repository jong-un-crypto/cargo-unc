use cargo_unc_integration_tests::generate_abi_fn;
use function_name::named;
use unc_abi::{AbiFunctionKind, AbiFunctionModifier};

#[test]
#[named]
fn test_view_function() -> cargo_unc::CliResult {
...
#[test]
#[named]
fn test_call_function() -> cargo_unc::CliResult {
    let abi_root = generate_abi_fn! {
...
#[test]
#[named]
fn test_init_function() -> cargo_unc::CliResult {
    let abi_root = generate_abi_fn! {
        #[init]
...
#[test]
#[named]
fn test_payable_function() -> cargo_unc::CliResult {
    let abi_root = generate_abi_fn! {
        #[payable]
        pub fn add(&mut self, a: u32, b: u32) -> u32 {
            a + b
...
#[test]
#[named]
fn test_private_function() -> cargo_unc::CliResult {
    let abi_root = generate_abi_fn! {
        #[private]
        pub fn add(&mut self, a: u32, b: u32) -> u32 {
            a + b
