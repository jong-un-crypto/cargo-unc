...
#[test]
#[named]
fn test_schema_numeric_primitives_signed() -> cargo_unc::CliResult {
...
#[test]
#[named]
fn test_schema_numeric_primitives_unsigned() -> cargo_unc::CliResult {
    let abi_root = generate_abi_fn! {
...
#[test]
#[named]
fn test_schema_numeric_primitives_float() -> cargo_unc::CliResult {
    let abi_root = generate_abi_fn! {
...
#[test]
#[named]
fn test_schema_string() -> cargo_unc::CliResult {
    let abi_root = generate_abi_fn! {
...
#[test]
#[named]
fn test_schema_other_primitives() -> cargo_unc::CliResult {
    let abi_root = generate_abi_fn! {
...
#[test]
#[named]
fn test_schema_tuples() -> cargo_unc::CliResult {
    let abi_root = generate_abi_fn! {
...
#[test]
#[named]
fn test_schema_arrays() -> cargo_unc::CliResult {
    let abi_root = generate_abi_fn! {
...
#[test]
#[named]
fn test_schema_struct() -> cargo_unc::CliResult {
...
#[test]
#[named]
fn test_schema_enum() -> cargo_unc::CliResult {
    let abi_root = generate_abi! {
        use near_sdk::borsh::{BorshDeserialize, BorshSerialize};
        use near_sdk::{near_bindgen, NearSchema};
        use near_sdk::serde::{Deserialize, Serialize};
...
#[test]
#[named]
fn test_schema_complex() -> cargo_unc::CliResult {
    let abi_root = generate_abi! {
        use near_sdk::borsh::{BorshDeserialize, BorshSerialize};
        use near_sdk::{near_bindgen, NearSchema};
        use near_sdk::serde::{Deserialize, Serialize};
