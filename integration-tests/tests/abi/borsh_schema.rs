...
use cargo_unc_integration_tests::{generate_abi, generate_abi_fn};
use function_name::named;
use std::collections::BTreeMap;

#[test]
#[named]
fn test_borsh_schema_numeric_primitives_signed() -> cargo_unc::CliResult {
...
#[test]
#[named]
fn test_borsh_schema_numeric_primitives_unsigned() -> cargo_unc::CliResult {
    let abi_root = generate_abi_fn! {
        pub fn foo(
            &self,
...
#[test]
#[named]
fn test_borsh_schema_numeric_primitives_float() -> cargo_unc::CliResult {
    let abi_root = generate_abi_fn! {
...
#[test]
#[named]
fn test_borsh_schema_string() -> cargo_unc::CliResult {
    let abi_root = generate_abi_fn! {
...
#[test]
#[named]
fn test_borsh_schema_other_primitives() -> cargo_unc::CliResult {
    let abi_root = generate_abi_fn! {
...
#[test]
#[named]
fn test_borsh_schema_tuples() -> cargo_unc::CliResult {
    let abi_root = generate_abi_fn! {
        pub fn foo(
            &self,
...
#[test]
#[named]
fn test_borsh_schema_arrays() -> cargo_unc::CliResult {
    let abi_root = generate_abi_fn! {
        pub fn foo(
            &self,
...
#[test]
#[named]
fn test_borsh_schema_struct() -> cargo_unc::CliResult {
...
#[test]
#[named]
fn test_borsh_schema_enum() -> cargo_unc::CliResult {
    let abi_root = generate_abi! {
        use near_sdk::borsh::{BorshDeserialize, BorshSerialize};
        use near_sdk::{near_bindgen, NearSchema};
...
#[test]
#[named]
fn test_borsh_schema_complex() -> cargo_unc::CliResult {
    let abi_root = generate_abi! {
        use near_sdk::borsh::{BorshDeserialize, BorshSerialize};
        use near_sdk::{near_bindgen, NearSchema};
