...
#[test]
#[named]
fn test_callbacks_unwrapped() -> cargo_unc::CliResult {
...
#[test]
#[named]
fn test_callbacks_result() -> cargo_unc::CliResult {
    let abi_root = generate_abi_fn! {
        pub fn foo(
            &self,
...
#[test]
#[named]
fn test_callbacks_vec() -> cargo_unc::CliResult {
    let abi_root = generate_abi_fn! {
        pub fn foo(
            &self,
...
#[test]
#[named]
fn test_callbacks_mixed_with_params() -> cargo_unc::CliResult {
    let abi_root = generate_abi_fn! {
        pub fn foo(
            &self,
            #[callback_unwrap] a: bool,
