use cargo_unc_integration_tests::{generate_abi_fn, generate_abi_fn_with};
use function_name::named;

#[test]
#[named]
fn test_abi_feature_not_enabled() -> cargo_unc::CliResult {
    fn run_test() -> cargo_unc::CliResult {
...
#[test]
#[named]
fn test_abi_old_sdk() -> cargo_unc::CliResult {
    fn run_test() -> cargo_unc::CliResult {
        generate_abi_fn_with! {
...
#[test]
#[named]
fn test_abi_weird_version() -> cargo_unc::CliResult {
    fn run_test() -> cargo_unc::CliResult {
        generate_abi_fn_with! {
...
#[test]
#[named]
fn test_abi_no_code() -> cargo_unc::CliResult {
    fn run_test() -> cargo_unc::CliResult {
        generate_abi_fn! {};
        Ok(())
    }
