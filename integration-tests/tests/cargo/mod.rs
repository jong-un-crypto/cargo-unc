use cargo_unc_integration_tests::{from_git, generate_abi_fn_with, generate_abi_with};
...
#[test]
#[named]
fn test_dependency_local_path() -> cargo_unc::CliResult {
    let near_sdk_dir = clone_git_repo()?;
    let near_sdk_dep_path = near_sdk_dir.path().join("unc-sdk");
...
#[test]
#[named]
fn test_dependency_local_path_with_version() -> cargo_unc::CliResult {
    let near_sdk_dir = clone_git_repo()?;
    let near_sdk_dep_path = near_sdk_dir.path().join("unc-sdk");
...
#[test]
#[named]
fn test_dependency_default_features() -> cargo_unc::CliResult {
    let abi_root = generate_abi_fn_with! {
...
#[test]
#[named]
fn test_dependency_explicit() -> cargo_unc::CliResult {
    let abi_root = generate_abi_fn_with! {
...
#[test]
#[named]
fn test_dependency_no_default_features() -> cargo_unc::CliResult {
    let abi_root = generate_abi_fn_with! {
...
#[test]
#[named]
fn test_dependency_multiple_features() -> cargo_unc::CliResult {
    let abi_root = generate_abi_fn_with! {
...
#[test]
#[named]
fn test_dependency_platform_specific() -> cargo_unc::CliResult {
    let abi_root = generate_abi_fn_with! {
...
#[test]
#[named]
fn test_dependency_patch() -> cargo_unc::CliResult {
    // [dependencies]
    // unc-sdk = "4.0.0"
    //
    // [patch.crates-io]
    // unc-sdk = { git = "https://github.com/unc/unc-sdk-rs.git", rev = "10b0dea3b1a214d789cc90314aa814a4181610ad" }
    let abi_root = generate_abi_fn_with! {
...
/// and `cargo_unc_integration_tests::SDK_VERSION` is changed 4.x.x -> 5.x.x
#[test]
#[ignore]
#[named]
fn test_abi_not_a_table() -> cargo_unc::CliResult {
    let abi_root = generate_abi_fn_with! {
