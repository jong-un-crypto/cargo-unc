use unc_cli_rs::commands::contract::deploy::initialize_mode::InitializeMode;

use crate::commands::build_command;

#[derive(Debug, Clone, interactive_clap::InteractiveClap)]
#[interactive_clap(input_context = unc_cli_rs::GlobalContext)]
...
pub struct Contract {
    ...
    contract_account_id: unc_cli_rs::types::account_id::AccountId,
    #[interactive_clap(subcommand)]
    initialize: InitializeMode,
}

#[derive(Debug, Clone)]
pub struct ContractContext(unc_cli_rs::commands::contract::deploy::ContractFileContext);

impl ContractContext {
    pub fn from_previous_context(
        previous_context: unc_cli_rs::GlobalContext,
        ...
        Ok(Self(
            unc_cli_rs::commands::contract::deploy::ContractFileContext {
...
impl From<ContractContext> for unc_cli_rs::commands::contract::deploy::ContractFileContext {
...
impl interactive_clap::FromCli for Contract {
    type FromCliContext = unc_cli_rs::GlobalContext;
...
impl Contract {
    pub fn input_contract_account_id(
        context: &unc_cli_rs::GlobalContext,
    ) -> color_eyre::eyre::Result<Option<unc_cli_rs::types::account_id::AccountId>> {
        unc_cli_rs::common::input_signer_account_id_from_used_account_list(
